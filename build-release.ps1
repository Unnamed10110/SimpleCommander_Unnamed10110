# Optimized release build of SimpleCommander (LTO, stripped) and WiX MSI.
...
$msi = Get-ChildItem -LiteralPath (Join-Path $PSScriptRoot "target\wix") -Filter "SimpleCommander-*.msi" |
